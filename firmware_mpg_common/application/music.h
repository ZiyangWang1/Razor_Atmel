...
#define/*1*/ C4                   (u32)NOTE_C4  /* Middle C */
#define C4S                  (u32)NOTE_C4_SHARP
#define/*2*/ D4                   (u32)NOTE_D4
#define D4S                  (u32)NOTE_D4_SHARP
#define/*3*/ E4                   (u32)NOTE_E4
#define/*4*/ F4                   (u32)NOTE_F4
#define F4S                  (u32)NOTE_F4_SHARP
#define/*5*/ G4                   (u32)NOTE_G4
#define G4S                  (u32)NOTE_G4_SHARP
#define/*6*/ A4                   (u32)NOTE_A4
#define A4S                  (u32)NOTE_A4_SHARP
#define/*7*/ B4                   (u32)NOTE_B4
#define/*1*/ C5                   (u32)NOTE_C5
#define C5S                  (u32)NOTE_C5_SHARP
#define/*2*/ D5                   (u32)NOTE_D5
#define D5S                  (u32)NOTE_D5_SHARP
#define/*3*/ E5                   (u32)NOTE_E5
#define/*4*/ F5                   (u32)NOTE_F5
#define F5S                  (u32)NOTE_F5_SHARP
#define/*5*/ G5                   (u32)NOTE_G5
#define G5S                  (u32)NOTE_G5_SHARP
#define/*6*/ A5                   (u32)NOTE_A5
#define A5S                  (u32)NOTE_A5_SHARP
#define/*7*/ B5                   (u32)NOTE_B5
#define/*1*/ C6                   (u32)NOTE_C6
#define C6S                  (u32)NOTE_C6_SHARP
#define/*2*/ D6                   (u32)NOTE_D6
#define D6S                  (u32)NOTE_D6_SHARP
#define/*3*/ E6                   (u32)NOTE_E6
#define/*4*/ F6                   (u32)NOTE_F6
#define F6S                  (u32)NOTE_F6_SHARP
#define/*5*/ G6                   (u32)NOTE_G6
#define G6S                  (u32)NOTE_G6_SHARP
#define/*6*/ A6                   (u32)NOTE_A6
#define A6S                  (u32)NOTE_A6_SHARP
#define/*7*/ B6                   (u32)NOTE_B6
#define NO                   (u32)NONE